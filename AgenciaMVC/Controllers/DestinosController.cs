...
namespace AgenciaMVC.Controllers
{
    public class DestinosController : Controller
    {
        ...
        public DestinosController(BancoDeDadosContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("IdDestino,nomeDestino,estadoDestino,paisDestino,valorDiaria,dataInicio,dataFinal")] Destino destino)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdDestino,nomeDestino,estadoDestino,paisDestino,valorDiaria,dataInicio,dataFinal")] Destino destino)
        {
